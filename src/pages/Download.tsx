...
import { Download, Smartphone, Apple, Play, QrCode, Star, Shield, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-gray-600">Scan to download for iPhone</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Google Play Store</h3>
              <p className="text-sm text-gray-600">Scan to download for Android</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">iOS Requirements</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-600" />
                  <span className="text-gray-700">iOS 13.0 or later</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-600" />
                  <span className="text-gray-700">iPhone 6s or newer</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-600" />
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Android Requirements</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-600" />
